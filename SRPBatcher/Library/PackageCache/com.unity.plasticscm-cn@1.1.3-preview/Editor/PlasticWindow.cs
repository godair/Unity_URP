...
namespace Unity.PlasticSCM.Editor
{
        ...
        CreateWorkspaceView.ICreateWorkspaceListener
    {
        ...
        void OnEnable()
        {
            ...
            EditorApplication.update += AutoCommit;
        }
        ...
        void AutoCommit()
        {
            ...
            if (elapsedSeconds < mFixedAutoCommitTime)
            {
                return;
            }
        ...
        static void DoAutoCommitCheckBox()
        {
            ...
            var chekboxLabel = "Auto Save";
            var tooltip = "Auto save every five minutes";
            
            var layoutOptions = GUILayout.Height(18);
            bool autoCommit = EditorPrefs.GetBool(mAutoCommitKey);           
            bool newAutocommit = GUILayout.Toggle(autoCommit, new GUIContent("", tooltip), layoutOptions);
            
            GUILayout.Label(new GUIContent(chekboxLabel, tooltip), layoutOptions);
